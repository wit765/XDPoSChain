...
// prestate_tracer_legacy.js (4.489kB)
...
func prestate_tracer_legacyJs() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xdf, 0xda, 0x43, 0x85, 0x7d, 0x3f, 0xf0, 0xdd, 0x14, 0xe7, 0x11, 0xfe, 0x20, 0x48, 0x95, 0x28, 0x65, 0x6, 0xd2, 0xb2, 0x99, 0x78, 0x51, 0x8d, 0x2d, 0xa3, 0x32, 0x76, 0xd1, 0xf2, 0xc, 0x27}}
	return a, nil
}
